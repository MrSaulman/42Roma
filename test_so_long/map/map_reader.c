...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/04 16:40:09 by asalvemi          #+#    #+#             */
/*   Updated: 2022/02/05 16:44:06 by asalvemi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	**alloc_columns(char *file)
{
	...
	if (line_count <= 0)
		return (null_error("Error: no lines found, the file may not exist"));
	map = malloc(sizeof(char *) * line_count + 1);
	if (map == NULL)
		return (null_error("Error: can't alloc memory on map"));
	return (map);
}

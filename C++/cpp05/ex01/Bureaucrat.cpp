...
void Bureaucrat::signForm(Form &form)
{
    if (form.getSign())
    {
        std::cout << "<" << this->getName() << ">" << "cannot sign" << "<" << form.getName() << ">" << "because" << "<" << "is already signed" << ">" << std::endl;
    }
    else if (this->_grade > form.getGradeSign())
    {
        std::cout << "<" << this->getName() << ">" << "cannot sign" << "<" << form.getName() << ">" << "because" << "<" << "is grade is too low" << ">" << std::endl;
    }
    else
    {
